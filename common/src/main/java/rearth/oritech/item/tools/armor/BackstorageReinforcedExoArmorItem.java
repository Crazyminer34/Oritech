...
public class BackstorageReinforcedExoArmorItem extends ReinforcedExoArmorItem implements OritechEnergyItem {
    
    public BackstorageReinforcedExoArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Item.Settings settings) {

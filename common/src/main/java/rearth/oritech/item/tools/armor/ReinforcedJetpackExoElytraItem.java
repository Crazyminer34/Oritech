...
public class ReinforcedJetpackExoElytraItem extends BackstorageReinforcedExoArmorItem implements BaseJetpackItem {
    public ReinforcedJetpackExoElytraItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public Identifier getModel() {
        return Oritech.id("armor/reinforced_exo_armor_jetpack");
    }
    ...
    public float getSpeed() {
        return Oritech.CONFIG.reinforcedexoElytraJetpack.speed();
    }
    
    @Override
    public int getRfUsage() {
        return Oritech.CONFIG.reinforcedexoElytraJetpack.energyUsage();
    }
    
    @Override
    public int getFuelUsage() {
        return Oritech.CONFIG.reinforcedexoElytraJetpack.fuelUsage();
    }
    
    @Override
    public long getFuelCapacity() {
        return Oritech.CONFIG.reinforcedexoElytraJetpack.fuelCapacity();
    }
    
    @Override
    public long getEnergyCapacity(ItemStack stack) {
        return Oritech.CONFIG.reinforcedexoElytraJetpack.energyCapacity();
    }
    
    @Override
    public long getEnergyMaxInput(ItemStack stack) {
        return Oritech.CONFIG.reinforcedexoElytraJetpack.chargeSpeed();
    }
}

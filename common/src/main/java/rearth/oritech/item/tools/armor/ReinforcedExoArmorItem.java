...
public class ReinforcedExoArmorItem extends ArmorItem implements GeoItem, ArmorEventHandler {
    
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    
    public ReinforcedExoArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public @Nullable <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(@Nullable T livingEntity, ItemStack itemStack, @Nullable EquipmentSlot equipmentSlot, @Nullable BipedEntityModel<T> original) {
                ...
                if (this.renderer == null)
                    this.renderer = new ExosuitArmorRenderer(getModel(), Oritech.id("armor/reinforced_exo_armor"));
    ...
    public Identifier getModel() {
        return Oritech.id("armor/reinforced_exo_armor");
    }

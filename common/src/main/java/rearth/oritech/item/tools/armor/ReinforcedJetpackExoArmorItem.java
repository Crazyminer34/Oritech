...
public class ReinforcedJetpackExoArmorItem extends BackstorageReinforcedExoArmorItem implements BaseJetpackItem {
    public ReinforcedJetpackExoArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Item.Settings settings) {
